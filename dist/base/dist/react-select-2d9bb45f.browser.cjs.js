  ...
  _createClass(Select, [{
    ...
    value: function renderPlaceholderOrValue() {
      ...
      var _this$props15 = this.props,
          ...
          maxNumberForMulti = _this$props15.maxNumberForMulti;
      ...
      if (isMulti) {
        var selectValues = function selectValues() {
          var arr = selectValue && maxNumberForMulti ? selectValue.filter(function (el, i) {
            return i > maxNumberForMulti - 1;
          }) : [];
          return React__default.createElement(React__default.Fragment, null, selectValue.map(function (opt) {
