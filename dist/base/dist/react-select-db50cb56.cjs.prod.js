...
var colors = {
  ...
  return _inherits(Select, _Component), _createClass(Select, [ {
    ...
    value: function() {
      var arr, _this4 = this, _this$components = this.components, MultiValue = _this$components.MultiValue, MultiValueContainer = _this$components.MultiValueContainer, MultiValueLabel = _this$components.MultiValueLabel, MultiValueRemove = _this$components.MultiValueRemove, SingleValue = _this$components.SingleValue, Placeholder = _this$components.Placeholder, commonProps = this.commonProps, _this$props15 = this.props, controlShouldRenderValue = _this$props15.controlShouldRenderValue, isDisabled = _this$props15.isDisabled, isMulti = _this$props15.isMulti, inputValue = _this$props15.inputValue, placeholder = _this$props15.placeholder, maxNumberForMulti = _this$props15.maxNumberForMulti, _this$state8 = this.state, selectValue = _this$state8.selectValue, focusedValue = _this$state8.focusedValue, isFocused = _this$state8.isFocused;
      ...
      if (isMulti) {
        return arr = selectValue && maxNumberForMulti ? selectValue.filter(function(el, i) {
          return i > maxNumberForMulti - 1;
        }) : [], React__default.createElement(React__default.Fragment, null, selectValue.map(function(opt) {
        ...
        }), maxNumberForMulti && arr.length && React__default.createElement("ul", {
          className: "customMultyBlock"
        }, arr.map(function(item) {
          var isOptionFocused = item === focusedValue;
          return React__default.createElement(MultiValue, _extends({}, commonProps, {
            components: {
              Container: MultiValueContainer,
              Label: MultiValueLabel,
            ...
            isFocused: isOptionFocused,
            isDisabled: isDisabled,
            key: _this4.getOptionValue(item),
            removeProps: {
              onClick: function() {
                return _this4.removeValue(item);
              },
              onTouchEnd: function() {
                return _this4.removeValue(item);
              },
            ...
            data: item
          }), _this4.formatOptionLabel(item, "value"));
        })));
      }
